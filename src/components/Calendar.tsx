...
/*
  DONE-make isToday work
  -make isSelected work
  DONE-separate everything out into a hook
  -revisit the logic to see if there's anything that can be cleaned up
...
const Calendar = () => {
  ...
  return (
    <div>
      ...
      <div className="isolate my-2 grid grid-cols-7 gap-px rounded-lg bg-gray-200 text-sm shadow ring-1 ring-gray-200">
        {days.map((day, dayIdx) => (
          <button
